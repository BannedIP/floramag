...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="row">
        <?php if ($thumb) { ?>
        <div class="col-sm-2"><div class="category_img_thumb"><img src="<?php echo $thumb; ?>" alt="<?php echo $heading_title; ?>" title="<?php echo $heading_title; ?>" class="img-thumbnail" /></div></div>
        <?php } ?>
        <?php if ($description) { ?>
      ...
      <?php } else { ?>
      <div class="row">
        <?php foreach (array_chunk($categories, 6) as $categories) { ?>
        <div class="col-sm-3 col-md-12">
          <ul class="catimages navbar-nav">
            <?php foreach ($categories as $category) { ?>
            <li><a href="<?php echo $category['href']; ?>"><div class="category_img"><img src="<?php echo $category['image']; ?>"></div><p><?php echo $category['name']; ?></p></a></li>
